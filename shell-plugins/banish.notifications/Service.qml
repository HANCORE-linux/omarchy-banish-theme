...
Item {
  ...
  Variants {
    ...
    PanelWindow {
      ...
      readonly property int shadowMargin: Color.shellValues["notifications.floating-shadow"] === "true" ? 24 : 0

      ColumnLayout {
        id: popupColumn
        anchors.right: parent.right
        anchors.top: parent.top
        anchors.topMargin: Math.max(popupWindow.popupPlacement.margins.top, popupWindow.shadowMargin)
        anchors.rightMargin: Math.max(popupWindow.popupPlacement.margins.right, popupWindow.shadowMargin)
        ...
        Repeater {
          ...
          delegate: Item {
            ...
            RectangularShadow {
              anchors.fill: card
              visible: Color.shellValues["notifications.floating-shadow"] === "true"
              ...
              color: Qt.rgba(0, 0, 0, Color.pickAlpha("floating-shadow.opacity", 0.55))
              cached: true
            }
