...
Item {
  ...
  PanelWindow {
    ...
    RectangularShadow {
      anchors.fill: card
      visible: Color.shellValues["osd.floating-shadow"] === "true"
    ...
    BorderSurface {
      ...
      borderSpec: Color.shellValues["osd.border"]
        ? Border.surfaceSpec("osd", "border", Color.popups.border, Math.max(1, Style.space(2)))
